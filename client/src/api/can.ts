...
import type { CanConnectionStatus, CanDeviceInfo, DbcMessage } from "../generated/types";
...
export async function connectCanDevice(portName: string, bitrate: number): Promise<void> {
